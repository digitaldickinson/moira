...
6. When prompted, select **Use a Script tag**
7. Firebase will display a config script. The important part is the "You web app's Firebase configuration". It will look something like the code below.
