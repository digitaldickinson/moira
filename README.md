...
But those principles mean it's not perfect. They mean comprises and challenges. Perhaps the biggest is the use of the FIRESTORE database. This is both a vulnerability and a barrier - these things are never easy to set up for non-geeks. However, I hope the setup process is as easy as it can be, given the functionality on offer. 
